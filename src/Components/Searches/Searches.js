...
class Searches extends Component{
    ...
    componentDidMount(){
        ...
        axios.get('http://2b381dfbd382.ngrok.io/user/'+this.props.match.params.name,{    
            headers: {
    ...
    addFriendHandler=()=>{
     let   friendData={
        ...
        let token = localStorage.getItem('token')
        axios.post('http://2b381dfbd382.ngrok.io/send-request',friendData,{
    ...
    cancelFriendhandler=()=>{
        ...
        let token = localStorage.getItem('token')
        axios.post('http://2b381dfbd382.ngrok.io/cancel-request',friendData,{
