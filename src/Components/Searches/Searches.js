...
class Searches extends Component{
    ...
    componentDidMount(){
        ...
        axios.get('http://de08e7e9431f.ngrok.io/user/'+this.props.match.params.name,{    
            headers: {
    ...
    addFriendHandler=()=>{
     let   friendData={
        ...
        let token = localStorage.getItem('token')
        axios.post('http://de08e7e9431f.ngrok.io/send-request',friendData,{
    ...
    cancelFriendhandler=()=>{
        ...
        let token = localStorage.getItem('token')
        axios.post('http://de08e7e9431f.ngrok.io/cancel-request',friendData,{
