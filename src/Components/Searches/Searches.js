...
class Searches extends Component{
    ...
    componentDidMount(){
        ...
        axios.get('http://c0c58a590c5a.ngrok.io/user/'+this.props.match.params.name,{    
            headers: {
    ...
    addFriendHandler=()=>{
     let   friendData={
        ...
        let token = localStorage.getItem('token')
        axios.post('http://c0c58a590c5a.ngrok.io/send-request',friendData,{
    ...
    cancelFriendhandler=()=>{
        ...
        let token = localStorage.getItem('token')
        axios.post('http://c0c58a590c5a.ngrok.io/cancel-request',friendData,{
